...
class DashboardTab extends StatelessWidget {
  final List<Map<String, dynamic>> menuItems = [
    ...
    {'icon': Icons.book, 'label': 'Jurusan'},
    {'icon': Icons.visibility, 'label': 'About Us'},
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
              'Email: nagithasyahiranie@gmail.com',
          ...
          ListTile(
            ...
            title: Text('Nagitha Syahiranie Suryadi', style: TextStyle(color: Colors.blueGrey)),
            subtitle:
                Text('Nagitha/Gita', style: TextStyle(color: Colors.grey[600])),
          ),
          ListTile(
            leading: Icon(Icons.cake, color: Colors.blueGrey),
            title:
                Text('Date of Birth', style: TextStyle(color: Colors.blueGrey)),
            subtitle: Text('25 Juny 2007',
                style: TextStyle(color: Colors.grey[600])),
          ),
        ],
      ),
